...
//
__attribute__((weak)) int My_I2C_SendBytes(I2C_TypeDef *I2Cx, uint8_t Addr, const uint8_t *pData, uint16_t Size)
{
	// #1. 等待总线空闲
...
// @返回值：0 - 发送成功， -1 - 寻址失败
//
__attribute__((weak))int My_I2C_ReceiveBytes(I2C_TypeDef *I2Cx, uint8_t Addr, uint8_t *pBuffer, uint16_t Size)
{
	if(Size == 0) return 0;
